...
import org.spring.springboot.solr.common.field.SearchableSupplyDefinition;
...
public class SupplyDoument implements SearchableSupplyDefinition {
    ...
    private
    @Id
    @Indexed(SUPPLU_ID_FIELD_NAME)
    String supplyId;

    private
    @Indexed(SUPPLY_IMG_FIELD_NAME)
    String supplyImg;

    private
    @Indexed(CRE_DATE_FIELD_NAME)
    String creDate;

    private
    @Indexed(SUPPLY_PRICE_FIELD_NAME)
    String supplyPrice;

    private
    @Indexed(TECH_PROSPECT_FIELD_NAME)
    String techProspect;

    private
    @Indexed(SUPPLY_TITLE_FIELD_NAME)
    String supplyTitle;
